  ...
  class TestOptions
    class TestPrefixPatternTest < MiniTest::Test
      ...
      def test_multiple_matches
        ...
        assert_equal ['test/models/valuation/test_holdings.rb'], TestOptions.for('app/models/valuation/holdings.rb', files: files)
      end
    ...
    class MultiplePatternTest < MiniTest::Test
      def test_multiple_test_naming_patterns
        ...
        assert_equal files, TestOptions.for('lib/holdings.rb', files: files, limit: 8)
      end
    end
  end
end
