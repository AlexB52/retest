class FileChangesTest < Minitest::Test
  ...
  def test_modifying_existing_file
    ...
    assert_match "Test File Selected: test/test_bottles.rb", @output.read
  ...
  def test_modifying_existing_test_file
    ...
    modify_file('test/test_bottles.rb')
  ...
  def test_creating_a_new_test_file
    ...
    create_file 'test_foo.rb'

    assert_match "Test File Selected: test_foo.rb", @output.read

    delete_file 'test_foo.rb'
  end
  ...
  def test_untracked_file
    ...
    create_file 'test_foo.rb', should_sleep: false
